...
var file_onchain_event_proto_rawDesc = []byte{
	...
	0x5f, 0x52, 0x45, 0x43, 0x4f, 0x56, 0x45, 0x52, 0x59, 0x10, 0x03, 0x42, 0x23, 0x5a, 0x21, 0x67,
...
func file_onchain_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_onchain_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_onchain_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_onchain_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_onchain_event_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_onchain_event_proto_msgTypes[4].Exporter = func(v any, i int) any {
